...
class AppTextStyles {
  ...
  static final TextStyle heading1black = GoogleFonts.catamaran(
    textStyle: const TextStyle(
      color: Colors.black,
      letterSpacing: .5,
      fontWeight: FontWeight.bold,
  ...
  static final TextStyle mediumblack = GoogleFonts.notoSans(
    textStyle: const TextStyle(
      color: Colors.black,
      letterSpacing: .5,
  ...
  static final TextStyle smallblack = GoogleFonts.notoSans(
    textStyle: const TextStyle(
      color: Colors.black,
      letterSpacing: .5,
      fontSize: 12,
